		   ...
		   //   $error = '<div class="error_message">Attention! Phone number can only contain digits.</div>';
			...
			if($error == '') {
				...
				if(get_magic_quotes_gpc()) {
				 ...
				 $address = "mikee@bleucellar.com";
	
	
				 // Configuration option.
				 // i.e. The standard subject will appear as, "You've been contacted by John Doe."
				 
				 // Example, $e_subject = '$fullname . ' has contacted you via Your Website.';
				 ...
				 $e_body = "You have been contacted by $fullname with regards to $subject, their additional message is as follows.\r\n\n";
				 $e_content = "\"$comments\"\r\n\n";
			 
				 // Configuration option.
				 // RIf you active phone number, swap the tags of $e-reply below to include phone number.
				 //$e_reply = "You can contact $fullname via email, $email or via phone $phone";
...
?>
            ...
            <fieldset>
                ...
                <form  method="post" action="">
                    ...
                    <input name="name" type="text" id="name" size="30" value="<?=$fullname;?>" />
